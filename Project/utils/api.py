...
if __name__ == "__main__":
    ...
    querystring = {"limit":"48","categoryId":"4209","offset":"0","store":"US","lang":"en-US","sizeSchema":"US","currency":"USD","sort":"freshness","country":"US"}
    
    resp = API.get("/products/v2/list", querystring)
    print(resp)