...
#dg574 and 10/23/23 here we are trying to implement the test cases for pumpkin machine
@pytest.fixture
...
#dg574 and 10/23/23 In this test case we are making sure that pumpkin would be the first selection
...
#dg574 and 10/23/23 In this test case we are implementing that we can add  face stencils only if they're in stock
...
#dg574 and 10/23/23 In this test case we are implementing that we can add extras for the pumpkins only if they're in stock
...
#dg574 and 10/23/23 Here we are writing a test case to add up to 3 face stencils of any combination
...
#dg574 and 10/23/23 Here we are implementing a test case to add up to 3 extras of any combination
...
# dg574 and 10/23/23 This test is parameterized to cover different pumpkin choices and costs
...
# dg574 and 10/23/23 This test is parameterized to cover different combinations of choices and costs
...
# Test 8 -  dg574 and 10/23/23 Total products variable should properly increment after a successful purchase
