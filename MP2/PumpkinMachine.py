...
class PumpkinMachine:
    ...
    def __init__(self):
        #dg574 and 10/23/23 this is the init method
        self.pumpkins = [
    ...
    def set_current_stage(self, stage):
        # Set the current stage of the machine
        #dg574 and 10/23/23 here we are taking the current stage 
        self.currently_selecting = stage

    def get_total_sales(self):
        # Return the total sales amount
        #dg574 and 10/23/23 here we use this ti get total sales
        return self.total_sales

    def pick_pumpkin(self, choice):
        # Select a pumpkin based on the user's choice
        #dg574 and 10/23/23 by using method we can pick a pumpkin
    ...
    def pick_face_stencil(self, choice):
        # Select a face stencil based on the user's choice
        #dg574 and 10/23/23 by using this we pick face stencils
    ...
    def pick_extras(self, choice):
        # Select extras based on the user's choice
        #dg574 and 10/23/23 and here we pick extras
    ...
    def reset(self):
        # Reset the machine for a new order
        #dg574 and 10/23/23 this method is used to reset
    ...
    def clean_machine(self):
        # Clean the machine to reset its uses
        #dg574 and 10/23/23 by using method we can clean the machine
        self.remaining_uses = self.USES_UNTIL_CLEANING

    def handle_pumpkin_choice(self, _pumpkin):
        #dg574 and 10/23/23 by using this method we can handle pumpkin choice 
        if self.currently_selecting == STAGE.Pumpkin:
    ...
    def handle_face_stencil_choice(self, _face_stencil):
        #dg574 and 10/23/23 by using this method we can handle face stencil choice 
    ...
    def handle_extra_choice(self, _extra):
        #dg574 and 10/23/23 here we handle extra choice
        if _extra == "done":
    ...
    def handle_pay(self, expected, total):
        #dg574 and 10/23/23 in this method we handle payments for our purchase 
    ...
    def print_current_pumpkin(self):
        #dg574 and 10/23/23 here we can print current pumpkin
        print(f"Current Pumpkin: {', '.join([x.name for x in self.inprogress_pumpkin])}")

    def calculate_cost(self):
        #dg574 and 10/23/23 we are using this method to calculate the cost of our purchase
        total_cost = 0
    ...
    def run(self):
        #dg574 and 10/23/23 we use this method to implement all the exceptions and stages of the pumpkin vending machine 
        try:
            while True:
                if self.currently_selecting == STAGE.Pumpkin:
                    pumpkin = input(
            ...
            #dg574 and 10/23/23 outofexception
            print(str(e))
        except NeedsCleaningException:
            #dg574 and 10/23/23 needscleanexception
            ...
            #dg574 and 10/23/23 invalidchoiceexception
            print(str(e))
        except ExceededRemainingChoicesException as e:
            #dg574 and 10/23/23 exceededremainingexception
            print(str(e))
            if self.currently_selecting == STAGE.Pumpkin:
                self.currently_selecting = STAGE.FaceStencil
            elif self.currently_selecting == STAGE.FaceStencil:
            ...
            #dg574 and 10/23/23 invalidpaymentexception
            print(str(e))
        except Exception as e:
            #dg574 and 10/23/23 for any other exceptions
